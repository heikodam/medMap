# DEPRECATED: This file has been refactored into ranking_score_helpers.py and run_ranking_score.py
# Please use `python run_ranking_score.py <iso_code>` instead

print("This file is deprecated. Please use `python run_ranking_score.py <iso_code>` instead.")
